...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ApprovalDecision: 'approval.md',
  ApprovalPolicy: 'approval.md',
  ApprovalRequest: 'approval.md',
  ApprovalService: 'approval.md',
  InteractionActor: 'approval.md',
  RequiredInteractionActor: 'approval.md',
  ...
  CommandGuard: 'commands.md',
  CommandIngress: 'commands.md',
  CommandInvocation: 'commands.md',
  ...
  SessionExtensionDescriptor: 'session.md',
  SessionExtensionRegistration: 'session.md',
  SessionExtensionType: 'session.md',
